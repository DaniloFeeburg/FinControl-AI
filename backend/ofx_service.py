...
async def suggest_category_with_ai(
    ...
    Usa apenas Z.AI (GLM-4.7) como provedor principal.
    """
    import asyncio
    import os
    
    # Obtém API key do Z.AI
    ...
    if zai_key:
        try:
            from .ai_zai import suggest_category
            ...
            print(f"[IA-Z.AI] Erro ao sugerir categoria: {str(e)}")
            return None, 0.0
    
    # Nenhum provedor configurado
    print("[IA] ZAI_API_KEY não configurada")
    return None, 0.0
